...
import * as import1 from 'ng2-bootstrap/components/datepicker/datepicker.module';
...
import * as import7 from 'ng2-bootstrap/components/utils/components-helper.service';
...
class DatepickerModuleInjector extends import0.NgModuleInjector<import1.DatepickerModule> {
  ...
  __ComponentsHelper_6:import7.ComponentsHelper;
  ...
  get _ComponentsHelper_6():import7.ComponentsHelper {
    if ((this.__ComponentsHelper_6 == (null as any))) { (this.__ComponentsHelper_6 = new import7.ComponentsHelper(this.parent.get(import10.ApplicationRef),this,this)); }
    return this.__ComponentsHelper_6;
  }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import7.ComponentsHelper)) { return this._ComponentsHelper_6; }
